...
jQuery('.orderform fieldset .item-cards .row:nth-child(2) .col-lg-4:nth-child(1) .item-details').prepend('<img src="https://appsbrite.github.io/ecomey/images/icons/icon-service-4.png" alt="">');
jQuery('.orderform fieldset .item-cards .row:nth-child(2) .col-lg-4:nth-child(2) .item-details').prepend('<img src="https://appsbrite.github.io/ecomey/images/icons/icon-service-5.png" alt="">');
...
jQuery('#stripe_method + .custom-control-label .d-flex ').prepend('<div class="payment-stripe-logo"><img src="https://appsbrite.github.io/ecomey/images/logo-stripe.svg" alt=""></div>');
